...
class _MyHomePageState extends State<MyHomePage> {
  ...
  late MtcVideoPlayerController _customVideoPlayerController;
  late MtcVideoPlayerWebController _customVideoPlayerWebController;

  final CustomVideoPlayerSettings _customVideoPlayerSettings =
      const CustomVideoPlayerSettings(showSeekButtons: true);

  final MtcVideoPlayerWebSettings _customVideoPlayerWebSettings =
      MtcVideoPlayerWebSettings(
    src: longVideo,
  );
  ...
  void initState() {
    ...
    _customVideoPlayerWebController = MtcVideoPlayerWebController(
